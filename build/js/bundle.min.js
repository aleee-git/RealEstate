function darkMode(){document.querySelector(".dark-mode").addEventListener("click",(function(){document.body.classList.toggle("dark-mood")}))}function eventListener(){document.querySelector(".mobile-menu").addEventListener("click",responsive)}function responsive(){document.querySelector(".navegacion").classList.toggle("mostrar")}
