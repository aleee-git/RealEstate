function darkMode(){const e=window.matchMedia("(prefers-color-scheme: dark)");e.matches?document.body.classList.add("dark-mood"):document.body.classList.remove("dark-mood"),e.addEventListener("change",(function(){e.matches?document.body.classList.add("dark-mood"):document.body.classList.remove("dark-mood")}));document.querySelector(".dark-mode").addEventListener("click",(function(){document.body.classList.toggle("dark-mood")}))}function eventListener(){document.querySelector(".mobile-menu").addEventListener("click",responsive)}function responsive(){document.querySelector(".navegacion").classList.toggle("mostrar")}
