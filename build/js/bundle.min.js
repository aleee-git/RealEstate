function eventListener(){document.querySelector(".mobile-menu").addEventListener("click",responsive)}function responsive(){document.querySelector(".navegacion").classList.toggle("mostrar")}
